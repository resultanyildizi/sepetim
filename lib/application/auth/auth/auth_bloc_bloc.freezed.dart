...
// ignore: unused_element
  _Authenticated authenticated(
      {@required SignInType signInType, @required DomainUser user}) {
...
mixin _$AuthState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result authenticated(SignInType signInType, DomainUser user),
    @required Result unauthenticated(),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result initial(),
    Result authenticated(SignInType signInType, DomainUser user),
...
abstract class _$AuthenticatedCopyWith<$Res> {
  ...
  $Res call({SignInType signInType, DomainUser user});
...
class __$AuthenticatedCopyWithImpl<$Res> extends _$AuthStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_Authenticated(
      ...
      user: user == freezed ? _value.user : user as DomainUser,
    ));
  }
...
abstract class _Authenticated implements AuthState {
  const factory _Authenticated(
      ...
      @required DomainUser user}) = _$_Authenticated;
